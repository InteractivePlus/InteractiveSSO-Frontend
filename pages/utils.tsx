...
export const FormButtomLink = (props) => (
    <div className="flex justify-between flex-row w-full px-5 mb-5 mt-8 text-blue-500">
        <div>
            <a href={props.leftlink} className="hover:text-blue-600 hover:underline cursor-pointer"> {props.left}</a>

        </div>
        <div>
            <a href={props.rightlink} className="hover:text-blue-600 hover:underline cursor-pointer"> {props.right} </a>
